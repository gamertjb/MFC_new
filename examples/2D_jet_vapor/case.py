    ...
    json.dumps(
        {
            ...
            # Patch 3: vapor core embedded in the jet ------------------------
            ...
            "patch_icpp(3)%length_x": 0.25 * jet_length_x,
            "patch_icpp(3)%length_y": 0.25 * jet_length_y,
